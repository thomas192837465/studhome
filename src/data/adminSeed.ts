...
import type { AdminListing, Signalement, AdminTransaction, Administrator, ActivityLog } from "./adminTypes";

export const seedAdminListings: AdminListing[] = [
  {
    id: "1256",
    title: "Chambre meublée à Bastos",
    ville: "Yaoundé",
    quartier: "Bastos",
    price: 17000,
    owner: "DALIA ABENA",
    ownerPhone: "+237 699 999 999",
    submitted: "Aujourd'hui, 10:30",
    status: "En attente",
    image: houseImg,
    universities: ["Université de Yaoundé 1"],
    description: "Chambre meublée avec salle d'eau interne, eau chaude, wifi, groupe électrogène et parking. Quartier calme et sécurisé.",
  ...
  },
  {
    ...
    price: 25000,
    owner: "Junior F.",
    ownerPhone: "+237 655 12 34 56",
    submitted: "Aujourd'hui, 09:15",
    status: "En attente",
    image: houseImg,
    universities: ["Université de Douala"],
    description: "Studio moderne et lumineux, cuisine équipée, proche du centre-ville.",
  ...
  },
  {
    ...
    price: 40000,
    owner: "Marie N.",
    ownerPhone: "+237 677 98 76 54",
    submitted: "Hier, 18:45",
    status: "Modifications demandées",
    image: houseImg,
    universities: ["Université de Buea"],
    description: "Appartement spacieux 2 pièces, idéal colocation.",
    equipements: ["Eau chaude", "Wi-Fi", "Gardien"],
    modificationMessage:
    ...
    modificationReason: "Informations incomplètes",
  },
  {
    id: "1253",
    ...
    price: 12000,
    owner: "Kevin D.",
    ownerPhone: "+237 690 11 22 33",
    submitted: "Hier, 16:20",
    status: "En attente",
    image: houseImg,
    universities: ["Université de Dschang"],
    description: "Chambre simple proche du campus universitaire.",
  ...
  },
  {
    ...
    price: 22000,
    owner: "Sarah K.",
    ownerPhone: "+237 698 44 55 66",
    submitted: "Hier, 15:05",
    status: "Publiée",
    image: houseImg,
    universities: ["Université de Yaoundé 1"],
    description: "Studio meublé et rénové, proche des transports.",
    equipements: ["Eau chaude", "Wi-Fi"],
  },
];
